...
class AppFctComp3(QDialog):
    ...
    def refreshResult(self):
        ...
        #if not self.ui.comboBox_3_categorie.currentText():
        ...
        try:
            ...
            result = cursor.execute(
                ...
                [self.ui.comboBox_3_categorie.currentText()])
    ...
    def refreshCatList(self):
        ...
        try:
            ...
            self.ui.comboBox_3_categorie.clear()
        else:
            display.refreshGenericCombo(self.ui.comboBox_3_categorie, result)