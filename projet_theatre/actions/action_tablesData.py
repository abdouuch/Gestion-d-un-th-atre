...
class AppTablesData(QDialog):
    ...
    def refreshAllTables(self):
        ...
        self.refreshTable(self.ui.label_representations, self.ui.tableRepresentations, "SELECT noSpec,dateRep, promoRep, nbrPlacesDisp FROM LesRepresentations")
        ...
        self.refreshTable(self.ui.label_tickets, self.ui.tableTickets, "SELECT noSpec, dateRep, noPlace, noRang, dateEmTick, libelleCat, noDos FROM LesTickets")
        ...
        self.refreshTable(self.ui.label_categories, self.ui.tableCategories, "SELECT libelleCat, tauxReduction FROM LesCategoriesTickets")