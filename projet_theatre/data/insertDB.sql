...
insert into LesCategoriesTickets(libelleCat, tauxReduction) values ('normal', 1.0);
insert into LesCategoriesTickets(libelleCat, tauxReduction) values ('adherent', 0.4);
insert into LesCategoriesTickets(libelleCat, tauxReduction) values ('senior', 0.2);
insert into LesCategoriesTickets(libelleCat, tauxReduction) values ('etudiant', 0.1);
insert into LesCategoriesTickets(libelleCat, tauxReduction) values ('militaire', 0.2);


insert into LesTickets(noSpec, dateRep, noPlace, noRang, dateEmTick, libelleCat, noDos) values (1, '24/12/2019 17:00', 1, 1, '23/12/2019 21:30:20', 'adherent', 1);
insert into LesTickets(noSpec, dateRep, noPlace, noRang, dateEmTick, libelleCat, noDos) values (1, '24/12/2019 17:00', 2, 1, '23/12/2019 21:30:20', 'normal', 1);
insert into LesTickets(noSpec, dateRep, noPlace, noRang, dateEmTick, libelleCat, noDos) values (1, '24/12/2019 17:00', 3, 1, '23/12/2019 21:30:20', 'normal', 1);
insert into LesTickets(noSpec, dateRep, noPlace, noRang, dateEmTick, libelleCat, noDos) values (1, '24/12/2019 17:00', 4, 1, '23/12/2019 21:30:20', 'etudiant', 1);
insert into LesTickets(noSpec, dateRep, noPlace, noRang, dateEmTick, libelleCat, noDos) values (1, '24/12/2019 17:00', 5, 1, '23/12/2019 21:30:20','etudiant', 1);

insert into LesTickets(noSpec, dateRep, noPlace, noRang, dateEmTick, libelleCat, noDos) values (2, '25/12/2019 23:00', 1, 2, '20/12/2019 22:31:00', 'normal', 2);
insert into LesTickets(noSpec, dateRep, noPlace, noRang, dateEmTick, libelleCat, noDos) values (2, '25/12/2019 23:00', 2, 2, '20/12/2019 22:31:00', 'militaire', 2);

insert into LesTickets(noSpec, dateRep, noPlace, noRang, dateEmTick, libelleCat, noDos) values (2, '25/12/2019 23:00', 1, 3, '20/12/2019 14:22:00', 'normal', 3);
insert into LesTickets(noSpec, dateRep, noPlace, noRang, dateEmTick, libelleCat, noDos) values (2, '25/12/2019 23:00', 2, 3, '20/12/2019 14:22:00', 'senior', 3);
