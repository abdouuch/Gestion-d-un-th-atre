...
from actions.action_fct_comp_Menu_8 import AppFctCompMenu8
...
class AppWindow(QMainWindow):
    ...
    # En cas de clic sur la fonction à compléter 2.1
    ...
    # En cas de clic sur la fonction à compléter 2.2
    ...
    # En cas de clic sur la fonction à compléter 3.1
    ...
    # En cas de clic sur la fonction à compléter 3.2
    def open_fct_comp_Menu_8(self):
        if self.fct_comp_Menu_8_dialog is not None:
            self.fct_comp_Menu_8_dialog.close()
        self.fct_comp_Menu_8_dialog = AppFctCompMenu8(self.data)
        self.fct_comp_Menu_8_dialog.show()
